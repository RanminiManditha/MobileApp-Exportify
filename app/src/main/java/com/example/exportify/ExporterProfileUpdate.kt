...
import com.example.exportify.databinding.ActivityExporterProfileUpdateBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase

class ExporterProfileUpdate : AppCompatActivity() {
    private lateinit var binding: ActivityExporterProfileUpdateBinding
    private lateinit var auth: FirebaseAuth
    private lateinit var databaseRef: DatabaseReference
    private lateinit var uid: String
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
         binding = ActivityExporterProfileUpdateBinding.inflate(layoutInflater)
