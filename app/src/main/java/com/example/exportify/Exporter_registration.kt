...
class Exporter_registration : AppCompatActivity() {

    private lateinit var binding:ActivityExporterRegistrationBinding
    var validityCount = 0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityExporterRegistrationBinding.inflate(layoutInflater)
    ...
    private fun createUser() {
        ...
        auth.createUserWithEmailAndPassword(email, pwd).addOnCompleteListener {
            ...
            if (it.isSuccessful) {
                ...
                val user= UserModel(fname,lname,pwd,confirmPwd,email,contactNo,country,state,zipcode,des,"exporter",auth.currentUser!!.uid)
    ...
    private fun validateFormData(){
        ...
        when (formVal.validatefName()) {
            is ValidationResult.Empty -> {
                binding.etFName.error = (formVal.validatefName() as ValidationResult.Empty).errorMessage
            }
        ...
        when (formVal.validatelName()) {
            is ValidationResult.Empty -> {
                binding.etLName.error = (formVal.validatelName() as ValidationResult.Empty).errorMessage
            }
            is ValidationResult.Valid -> {
                validityCount++
            }
        ...
        when (formVal.validatePwd()) {
            ...
            is ValidationResult.Invalid -> {
                binding.etPwd.error = (formVal.validatePwd() as ValidationResult.Invalid).errorMessage
            }
        }

        when (formVal.validateEmail()) {
            is ValidationResult.Empty -> {
                binding.etEmail.error = (formVal.validateEmail() as ValidationResult.Empty).errorMessage
            }
            is ValidationResult.Valid -> {
                validityCount++
            }
            is ValidationResult.Invalid -> {
                binding.etEmail.error = (formVal.validateEmail() as ValidationResult.Invalid).errorMessage
            }
        }

        when (formVal.validateContactNo()) {
            is ValidationResult.Empty -> {
                binding.etContactNo.error = (formVal.validateContactNo() as ValidationResult.Empty).errorMessage
            }
            is ValidationResult.Valid -> {
                validityCount++
            }
            is ValidationResult.Invalid -> {
                binding.etContactNo.error = (formVal.validateContactNo() as ValidationResult.Invalid).errorMessage
            }
        }

        when (formVal.validateState()) {
            is ValidationResult.Empty -> {
                binding.etState.error = (formVal.validateState() as ValidationResult.Empty).errorMessage
            }
            is ValidationResult.Valid -> {
                validityCount++
            }
            is ValidationResult.Invalid -> {
                binding.etState.error = (formVal.validateState() as ValidationResult.Invalid).errorMessage
            }
        }

        when (formVal.validateZipCode()) {
            is ValidationResult.Empty -> {
                binding.etZipCode.error = (formVal.validateZipCode() as ValidationResult.Empty).errorMessage
            }
            is ValidationResult.Valid -> {
                validityCount++
            }
            is ValidationResult.Invalid -> {
                binding.etZipCode.error = (formVal.validateZipCode() as ValidationResult.Invalid).errorMessage
            }
        }

        when (formVal.validateDescription()) {
            is ValidationResult.Empty -> {
                binding.etDes.error = (formVal.validateDescription() as ValidationResult.Empty).errorMessage
            }
            is ValidationResult.Valid -> {
                validityCount++
            }
            is ValidationResult.Invalid -> {
                binding.etDes.error = (formVal.validateDescription() as ValidationResult.Invalid).errorMessage
            }
        }
